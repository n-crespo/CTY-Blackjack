...
public class MainBlackJack {
  ...
  private static void playRound() {
    ...
    // if player says hit, gets a new card, adds it to player hand, and displays the
    // new hand, then asks again
    while (hit) {
    ...
    if (!playerRoundOver) {
      ...
      // checks if the dealer won or busted, otherwise compare dealer and player hand
      // and declare winner
      if (!dealerRoundOver) {
