...
public class Player {
  ...
  // method to make sure round isn't immediately over because the player busted or
  // won
  ...
  // checks any card in the player hand is an ace, then asks the player which
  // value they want it to have
  void checkAces() {
